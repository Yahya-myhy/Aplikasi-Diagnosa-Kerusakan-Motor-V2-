...
public class G22Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g22);
        ...
        rdogrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedPreferencesEditor.putString("g22_value", rdobtn.getTag().toString());
                sharedPreferencesEditor.putInt("g22_selected", checkedId);
