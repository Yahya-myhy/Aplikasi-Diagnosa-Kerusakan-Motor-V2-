...
public class G25Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g25);
        ...
        rdogrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedPreferencesEditor.putString("g25_value", rdobtn.getTag().toString());
                sharedPreferencesEditor.putInt("g25_selected", checkedId);
