...
public class G18Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdogrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedPreferencesEditor.putString("g18_value", rdobtn.getTag().toString());
                sharedPreferencesEditor.putInt("g18_selected", checkedId);
