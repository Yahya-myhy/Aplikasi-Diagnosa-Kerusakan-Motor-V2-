...
public class G29Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g29);
        ...
        rdogrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedPreferencesEditor.putString("g29_value", rdobtn.getTag().toString());
                sharedPreferencesEditor.putInt("g29_selected", checkedId);
