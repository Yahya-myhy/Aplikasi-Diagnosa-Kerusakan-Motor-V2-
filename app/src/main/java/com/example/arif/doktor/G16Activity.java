...
public class G16Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdogrp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                sharedPreferencesEditor.putString("g16_value", rdobtn.getTag().toString());
                sharedPreferencesEditor.putInt("g16_selected", checkedId);
